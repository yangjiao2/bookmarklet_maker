...
(function() {
        ...
        const ECO_2021 = ['core_app:ecosystem:sessions:core_session_count:fb_major_apps', 'core_app:ecosystem:sessions:core_session_count:fb_iphone', 'core_app:ecosystem:sessions:core_session_count:fb_android', 'core_app:ecosystem:sessions:core_session_count:fb_iphone_android', 'core_app:ecosystem:sessions:core_session_count:comet_www', 'core_app:ecosystem:sessions:core_session_count:fblite_android', 'local:local:usr_bvi_score_h2_2021:search_referred', 'local:usr_bvi_components_score_2021_h2:search_referred', 'local:user_bvi_components_score_h1_2021', 'local:user_bvi_scores_h1_2021', 'groups:growth:cedau:overall', 'groups:growth:cedau:by_interface', 'groups:membership:requests:by_source', 'search:friending:requests_sent_accepted:overall', 'marketplace:bsg_mli_fast:overall', 'marketplace:search:mp_tab_search_mli_global_search_overall:overall', 'shops:consumer:facebook:shops:daily:shops_visitors:overall', 'shops:consumer:facebook:shops:monthly:his:us_only', 'games:live_gaming_watch_time', 'games:instant:core:sessions', 'video:search:metrics:time_spent_total_s:overall', 'video:core:time_spent_total_ms:overall', 'video:planned_viewing:video_home_watch_time_ms:overall'];
        ...
        const metrics = [{
            ...
            },
            {
                ...
                filters: [],
                label: 'SRV Metrics',
                metricNames: ['core_app:ecosystem:sessions:core_session_count:fb_major_apps', 'core_growth:visitation:dap:overall_facebook', 'search:usage:volume_without_mp_watch:overall', 'search:downstream:content_actions:overall', 'search:value:overview:srv_v3:overall'],
                platformFilter: false,
            },
            {
                collections: [],
            ...
            },
            {
                ...
                },
                {
                    collections: [],
                    filters: [],
                    label: 'FBLite Search Core Metric',
                    metricNames: [],
                    platformFilter: false,
                },
                {
                    collections: ['lite_interfaces:fblite:android:core:diagnostics'],
                    filters: [],
                    label: 'lite_interfaces:fblite:android:core:diagnostics',
                    metricNames: [],
                    platformFilter: false,
                },
                {
                    collections: ['lite_interfaces:fblite:android:core'],
                    filters: [],
                    label: 'lite_interfaces:fblite:android:core',
                    metricNames: [],
                    platformFilter: false,
                },     
                {
                    collections: ['core_app:ecosystem:sessions:collection:fblite_android'],
                    filters: [],
                    label: 'core_app:ecosystem:sessions:collection:fblite_android',
                    metricNames: [],
                    platformFilter: false,
                },   
                {
                    collections: ['lite_interfaces:fblite:android:visitation:dap'],
                    filters: [],
                    label: 'lite_interfaces:fblite:android:visitation:dap',
                    metricNames: [],
                    platformFilter: false,
                },
                {
                    collections: ['lite_interfaces:fblite:perf:data_usage:client_measure:overall'],
                    filters: [],
                    label: 'lite_interfaces:fblite:perf:data_usage:client_measure:overall',
                    metricNames: [],
                    platformFilter: false,
                },     
                {
                    collections: ['lite_interfaces:fblite:android:perf:data_usage:unity_measure:overall'],
                    filters: [],
                    label: 'core_app:ecosystem:sessions:collection:fblite_android',
                    metricNames: [],
                    platformFilter: false,
            ...
            for (const {
                ...
                for (const {
                    ...
                    const config = {
                        ...
                        metric_absolute_end_time: Math.floor(Date.parse(endTime) / 1000) + SECONDS_IN_DAYS,
                        metric_absolute_start_time: Math.floor(Date.parse(endTime) / 1000) +
                            SECONDS_IN_DAYS -
                            7 * SECONDS_IN_DAYS,
                        metric_aggregation: 0,
                        metric_column: '',
                        metric_filters: filters != null ?
                            filters.map(filter => {
                                return {
                                    ...filter,
                                    type: 0
